...
//        resetRobotButton.setFont(new Font (Font.DIALOG, Font.BOLD, 15));
        ...
        clearErrorButton.setBounds(dashboardFunctionLabel.getX()+200,dashboardFunctionLabel.getY()+50,150,40);
...
//        });
        ...
        feedbackLabel.setBounds(robotConnectTitleLabel.getX(),dashboardFunctionLabel.getY()+300,700,robotConnectTitleLabel.getHeight());
        ...
        logLabel.setBounds(robotConnectTitleLabel.getX()+710,dashboardFunctionLabel.getY()+300,340,robotConnectTitleLabel.getHeight());
