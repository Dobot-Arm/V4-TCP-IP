...
namespace CSharpTcpDemo.com.dobot.api
{
    class FeedbackData
    {
        ...
        public const int ROBOT_MODE_POWEROFF = 3;
        ...
        public const int ROBOT_MODE_SINGLE_MOVE = 8;
        public const int ROBOT_MODE_ERROR = 9;
        public const int ROBOT_MODE_PAUSE = 10;
        public const int ROBOT_MODE_COLLISION = 11;
        #endregion
        ...
        public double ProgramState = 0;//脚本运行状态
        public double SafetyStatus = 0;//安全状态
        ...
        public double[] ActualTCPForce = new double[6];//TCP传感器力值
        ...
        public byte CollisionState = 0;//碰撞状态
        public byte ArmApproachState = 0;//小臂接近暂停状态
        public byte J4ApproachState = 0;//J4接近暂停
        public byte J5ApproachState = 0;//J5接近暂停
        public byte J6ApproachState = 0;//J6接近暂停
        
        public byte[] Reserved6 = new byte[77];//保留位
