...
class DobotApiDashboardAndMove(DobotApi):
    """
    ...
    def DO(self, index, status):
        ...
        """
        string = "DO({:d},{:d},2000)".format(index, status)
        self.send_data(string)
        return self.wait_reply()
    ...
    def MovJ(self, x, y, z, rx, ry, rz):
        ...
        self.log("{:f},{:f},{:f},{:f},{:f},{:f}".format(x, y, z, rx, ry, rz))
        string = "MovJ(pose ={ "+str(x)+","+str(y)+","+str(z)+","+str(rx)+","+str(ry)+","+str(rz)+"})"
        self.send_data(string)
        return self.wait_reply()
    ...
    def MovL(self, x, y, z, rx, ry, rz):
        ...
        #MovL({:f},{:f},{:f},{:f},{:f},{:f})
        string = "MovL(pose ={ "+str(x)+","+str(y)+","+str(z)+","+str(rx)+","+str(ry)+","+str(rz)+"})"
        self.send_data(string)
        return self.wait_reply()
    ...
    def JointMovJ(self, j1, j2, j3, j4, j5, j6):
        ...
        """
        #'"JointMovJ({:f},{:f},{:f},{:f},{:f},{:f})"'
        #'MovJ(joint = {{:f},{:f},{:f},{:f},{:f},{:f})'
        # self.log("{ {:f},{:f},{:f},{:f},{:f},{:f} } ".format(j1, j2, j3, j4, j5, j6))
        string = "MovJ(joint ={ "+str(j1)+","+str(j2)+","+str(j3)+","+str(j4)+","+str(j5)+","+str(j6)+"})"
        self.send_data(string)
        return self.wait_reply()
