...
namespace Dobot
{
    ...
    void CFeedback::ParseData(char* pBuffer)
    {
        ...
        m_feedbackData.Reserved3 = CBitConverter::ToDouble(pBuffer + iStartIndex);
        iStartIndex += 8;
        ...
        m_feedbackData.ProgramState = CBitConverter::ToDouble(pBuffer + iStartIndex);
        iStartIndex += 8;

        m_feedbackData.SafetyStatus = CBitConverter::ToDouble(pBuffer + iStartIndex);
        iStartIndex += 8;
        ...
        m_feedbackData.CollisionState = pBuffer[iStartIndex];
        iStartIndex += 1;
        m_feedbackData.ArmApproachState = pBuffer[iStartIndex];
        iStartIndex += 1;
        m_feedbackData.J4ApproachState = pBuffer[iStartIndex];
        iStartIndex += 1;
        m_feedbackData.J5ApproachState = pBuffer[iStartIndex];
        iStartIndex += 1;
        m_feedbackData.J6ApproachState = pBuffer[iStartIndex];
        iStartIndex += 1;
